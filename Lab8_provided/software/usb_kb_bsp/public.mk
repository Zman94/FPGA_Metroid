...
# setting SOPC_SYSID_BASE_ADDRESS is 0xc0
SOPC_SYSID_FLAG += --sidp=0xc0
ELF_PATCH_FLAG  += --sidp 0xc0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1476645571
SOPC_SYSID_FLAG += --timestamp=1476645571
ELF_PATCH_FLAG  += --timestamp 1476645571
